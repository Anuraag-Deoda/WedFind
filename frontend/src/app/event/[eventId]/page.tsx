  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gold/8 rounded-full blur-3xl" />
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center animate-fade-in">
            ...
            {stats && stats.image_count > 0 && (
              <div className="flex items-center justify-center gap-3 mt-4">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/60 backdrop-blur-sm rounded-full text-sm text-warm-600 border border-warm-100">
          ...
          <div className="space-y-3 animate-slide-up stagger-1">
            ...
            <Link href={`/event/${eventId}/find`} className="block group">
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-warm-800 to-warm-900 p-5 shadow-lg shadow-warm-900/15 transition-all duration-300 group-hover:shadow-xl group-hover:scale-[1.01]">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-cream">Find My Photos</h3>
                    <p className="text-sm text-warm-300 mt-0.5">Take a selfie to find all photos of you</p>
                  </div>
                  <svg className="w-5 h-5 text-warm-400 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <Link href={`/event/${eventId}/upload`} className="block group">
              <div className="rounded-2xl bg-white/70 backdrop-blur-sm p-5 border border-warm-100 transition-all duration-300 group-hover:bg-white group-hover:shadow-md group-hover:scale-[1.01]">
                <div className="flex items-center gap-4">
